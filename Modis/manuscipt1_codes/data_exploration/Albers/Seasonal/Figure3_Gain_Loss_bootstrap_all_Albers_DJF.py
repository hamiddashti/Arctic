...
out_dir = ("/data/home/hamiddashti/nasa_above/outputs/data_analyses/Seasonal/"
           "Albers/Figures_MS1/")
...
titles = [
    "Winter (DJF)","Summer (JJA)", "Spring (MAM)", "Fall (SON)"
]
...
gs.tight_layout(fig)
plt.savefig(out_dir + "Heat_Map_Seasonal.png")
print("all done!")
