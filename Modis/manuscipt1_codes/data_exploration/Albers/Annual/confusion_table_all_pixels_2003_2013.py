...
def my_fun(year1, year2, changed, luc_dir, NUMBER_OF_CLASSES, shapes):
    ...
    da.to_netcdf(out_dir + "confusion_tables_all_pixels" + str(year1) +
                 "_2013.nc")
...
out_dir = ("/data/home/hamiddashti/nasa_above/outputs/Sensitivity/EndPoints/"
           "Annual/Albers")
