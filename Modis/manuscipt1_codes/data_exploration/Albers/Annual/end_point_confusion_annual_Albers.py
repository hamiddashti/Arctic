...
et = xr.open_dataset(out_dir + "et_processed/Annual/albers_proj_ET_Annual.nc")
et = et["ET_Annual"]
albedo = xr.open_dataarray(
    out_dir + ("albedo_processed/final_albedo/annual/final_annual_albedo.nc"))
...
dlst_mean_total = xr.open_dataarray(
    out_dir +
    "Natural_Variability/Natural_Variability_Annual_outputs/Albers/dlst_total.nc"
)
dlst_mean_lcc = xr.open_dataarray(
    out_dir + ("Natural_Variability/Natural_Variability_Annual_outputs/Albers"
               "/dlst_lcc.nc"))
dlst_mean_nv = xr.open_dataarray(
    out_dir + ("Natural_Variability/Natural_Variability_Annual_outputs/Albers/"
               "dlst_nv_no_outlier.nc"))
...
det_total = xr.open_dataarray(
    out_dir +
    "Natural_Variability/Natural_Variability_Annual_outputs/Albers/det_total.nc"
)

det_lcc = xr.open_dataarray(
    out_dir +
    "Natural_Variability/Natural_Variability_Annual_outputs/Albers/det_lcc.nc")

det_nv = xr.open_dataarray(
    out_dir + ("Natural_Variability/Natural_Variability_Annual_outputs/Albers/"
               "det_nv_no_outlier.nc"))
...
ds.to_netcdf(out_dir +
             "Sensitivity/EndPoints/Annual/Albers/Confusion_Table_Albers.nc")
