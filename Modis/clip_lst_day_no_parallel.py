...
out_dir = "/data/ABOVE/MODIS/MYD21A2/MYD_LST_Day_Tiles/"
...
def myclip(tileID):
    ...
    print(" Saving LST Day tile ID:" + str(tileID))
    da_clip.to_netcdf(out_dir + "MYD_LST_Day_Tile_" + str(tileID) + ".nc")
...
# Read the nc file
ds = xr.open_dataset(in_dir + "MYD_LST_Day.nc", chunks=chunks)
