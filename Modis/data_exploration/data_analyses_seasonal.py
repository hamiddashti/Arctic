...
in_dir = ("/data/home/hamiddashti/mnt/nasa_above/working/modis_analyses/"
          "outputs/Sensitivity/EndPoints/Seasonal/JJA/")
out_dir = "/data/home/hamiddashti/mnt/nasa_above/working/modis_analyses/test/"

ECO_NAMES = ['EF', 'DF', 'shrub', 'herb', 'sparse', 'wetland', 'water']
...
with open(out_dir + "restults_seasonal.txt", "w") as txt_f:
    txt_f.write(
...
with open(out_dir + "restults_seasonal.txt", "a") as txt_f:
...
plt.tight_layout()
save(out_dir + "seasonal_gain_lost_extreme.png", dpi=600)
...
ax.set_xticklabels(ECO_NAMES)
plt.tight_layout()
save(out_dir + "seasonal_gain_extremes.png", dpi=600)
...
ax.set_xticklabels(ECO_NAMES)
plt.tight_layout()
save(out_dir + "seasonal_lost_extremes.png", dpi=600)
# ------------------------------------------------------------
