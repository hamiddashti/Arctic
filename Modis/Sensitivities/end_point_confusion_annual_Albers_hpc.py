...
out_dir = ("/home/u9/hamiddashti/nasa_above/tmp_outputs/")
luc_dir = (out_dir + "LUC/")

luc2003 = rasterio.open(luc_dir + 'mosaic_2003.tif')
luc2013 = rasterio.open(luc_dir + 'mosaic_2013.tif')

changed_pixels_mask = xr.open_dataarray(
    out_dir + "Natural_Variability_Annual_outputs/Albers/changed.nc")

lst_mean = xr.open_dataset(out_dir +
...
et = xr.open_dataset(out_dir + "et_processed/albers_proj_ET_Annual.nc")
et = et["ET_Annual"]
albedo = xr.open_dataarray(out_dir +
                           ("albedo_processed/final_annual_albedo.nc"))
...
dlst_mean_total = xr.open_dataarray(
    out_dir + "Natural_Variability_Annual_outputs/Albers/dlst_total.nc")
dlst_mean_lcc = xr.open_dataarray(
    out_dir + ("Natural_Variability_Annual_outputs/Albers/dlst_lcc.nc"))
dlst_mean_nv = xr.open_dataarray(out_dir + (
    "Natural_Variability_Annual_outputs/Albers/dlst_nv_no_outlier.nc"))
...
det_total = xr.open_dataarray(
    out_dir + "Natural_Variability_Annual_outputs/Albers/det_total.nc")

det_lcc = xr.open_dataarray(
    out_dir + "Natural_Variability_Annual_outputs/Albers/det_lcc.nc")

det_nv = xr.open_dataarray(out_dir + (
    "Natural_Variability_Annual_outputs/Albers/det_nv_no_outlier.nc"))

dalbedo_total = xr.open_dataarray(
    out_dir + ("Natural_Variability_Annual_outputs/Albers/dalbedo_total.nc"))
dalbedo_lcc = xr.open_dataarray(
    out_dir + "Natural_Variability_Annual_outputs/Albers/dalbedo_lcc.nc")
dalbedo_nv = xr.open_dataarray(out_dir + (
    "Natural_Variability_Annual_outputs/Albers/dalbedo_nv_no_outlier.nc"))
...
ds.to_netcdf(out_dir + "Sensitivity/Confusion_Table_Albers.nc")
