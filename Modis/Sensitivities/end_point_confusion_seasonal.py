...
changed_pixels_mask = xr.open_dataarray(
    ...
    "Natural_Variability_Seasonal_outputs/geographic/changed_pixels.nc")
...
for season in seasons:
    lst_mean = xr.open_dataarray(in_dir +
                                 ...
                                 season + ".nc")
    lst_day = xr.open_dataarray(
        in_dir + "LST_Final/LST/Seasonal_Mean/LST_Day_"+season+".nc")
    lst_night = xr.open_dataarray(
        in_dir + "LST_Final/LST/Seasonal_Mean/LST_Night_"+season+".nc")
    ...
    albedo = xr.open_dataarray(in_dir+"/Seasonal_Albedo/geographic/")
