...
fig_dir = "/data/home/hamiddashti/mnt/nasa_above/working/modis_analyses/test/"
...
ET = ET.sel(year=slice("2003", "2014"))
...
def dataset_encoding(xds):
    import pandas as pd
    cols = [
        'source', 'original_shape', 'dtype', 'zlib', 'complevel', 'chunksizes'
    ]
