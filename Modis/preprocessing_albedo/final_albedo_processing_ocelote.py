...
os.mkdir(out_dir + "step1_filtered_data")
os.mkdir(out_dir + "step2_filtered_data_cliped")
os.mkdir(out_dir + "step3_annual_tiles")
os.mkdir(out_dir + "step4_annual_mosaic_resampled")
os.mkdir(out_dir + "step5_final_albedo")
