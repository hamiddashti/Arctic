...
dlst_day_total_roll = dlst_day_total.rolling({
    "lat": WINSIZE,
    "lon": WINSIZE
},
                                             center=True).construct({
...
dlst_night_total_roll = dlst_night_total.rolling(
    {
        "lat": WINSIZE,
        "lon": WINSIZE
    }, center=True).construct({
...
det_total_roll = det_total.rolling({
    "lat": WINSIZE,
    "lon": WINSIZE
},
                                   center=True).construct({
...
dalbedo_total_roll = dalbedo_total.rolling({
    "lat": WINSIZE,
    "lon": WINSIZE
},
                                           center=True).construct({
...
det_lcc = det_total - det_res
dalbedo_lcc = dalbedo_total - dalbedo_res

dlst_mean_lcc.to_netcdf(out_dir + "dlst_mean_lcc.nc")
dlst_total.to_netcdf(out_dir + "dlst_mean_total.nc")
dlst_res.to_netcdf(out_dir + "dlst_mean_nv.nc")

dlst_day_lcc.to_netcdf(out_dir + "dlst_day_lcc.nc")
dlst_day_total.to_netcdf(out_dir + "dlst_day_total.nc")
dlst_day_res.to_netcdf(out_dir + "dlst_day_nv.nc")

dlst_night_lcc.to_netcdf(out_dir + "dlst_night_lcc.nc")
